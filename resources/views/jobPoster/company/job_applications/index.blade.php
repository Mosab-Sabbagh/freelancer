...
@section('title', 'عرض طلبات الوظيفة')

@section('content')
<div class="container my-5">
    <h1 class="text-center text-dark mb-5">الطلبات المقدمة للوظيفة</h1>
                ...
                <div class="card shadow-sm rounded-lg h-100 border-0">
                    <div class="card-body p-4 d-flex flex-column">
                        ...
                        <div class="mt-auto d-flex flex-column flex-sm-row justify-content-end gap-2 pt-3 border-top">
                            ...
                            @if(!$application->is_selected)
                                <form action="{{ route('poster.job.select', $application->id) }}" method="POST" class="d-inline-block">
                                    @csrf
                                    <button type="submit"
